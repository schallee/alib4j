...
class LocalNullSafe
{
	 ...
	 */
	static boolean pairsEquals(Object...objs)
	{
	...
	static String toString(@Nullable Object o, String ifNull)
	{
		String ret;
	...
	static <T extends Comparable<T>> int compare(@Nullable T a, @Nullable T b)
	{
		if(a == b)
			return 0;
		if(a == null)
